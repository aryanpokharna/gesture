...
const msg = document.getElementById("input_message").addEventListener("click");
...
const encrypted = generateKey(encryptAlgorithm, scopeEncrypt).then(function(keys) {
    ...
    encryptData(vector, keys.publicKey, msg).then(function(encryptedData) {
      console.log("<== ENCRYPTED MESSAGE ==> ", arrayBufferToBase64(encryptedData), " <==ACTUAL MESSAGE ==> ", msg)
